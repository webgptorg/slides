...
| Script | Purpose |
| --- | --- |
| `npm run coder:generate-boilerplates` | Runs `npx ptbk coder generate-boilerplates --template ./prompts/templates/common.md` to create new prompt files in `prompts/`. |
